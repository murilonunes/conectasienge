  ...
  return (
    <section className="card supplier-portal-card supplier-identity-card">
      ...
      <div className="supplier-portal-grid supplier-identity-grid">
        ...
        <label><span>E-mail *</span><input value={email} required type="email" onChange={(event) => onEmailChange(event.target.value)} placeholder="financeiro@empresa.com.br" /></label>
        <label><span>Telefone *</span><input value={phone} required type="tel" inputMode="tel" onChange={(event) => onPhoneChange(event.target.value)} placeholder="(00) 00000-0000" /></label>
      </div>
