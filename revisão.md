...
| Revisado | Alta | `/cotacoes/[id]/solicitacao-fornecedor` | `app/cotacoes/[id]/solicitacao-fornecedor/page.tsx`, `components/purchases/quotation-detail/tabs/insumos-tab.tsx`, `app/globals.css` | A aba Insumos abre uma solicitação de proposta em A4 horizontal para envio manual ao fornecedor, com itens, quantidades, especificações, observações e campos comerciais em branco. O relatório é protegido por sessão, não mostra preços ou decisões internas e permite imprimir ou salvar em PDF. |
